  ...
  return (
    <Section number={2} title="Publications & Research Projects">
      <Entry
        ...
        detail="Preprint, Co-first author"
        items={[
      ...
      <Entry
        ...
        detail="NAACL (Findings), Co-first author"
        items={[
      ...
      <Entry
        ...
        detail="Preprint, Third Author"
        items={[
          'Built evaluation set with 300 expert-level videos and 900 human-annotated questions',
          <>Cited by <a href="https://deepmind.google/models/gemini/pro/" target="_blank" rel="noopener noreferrer">Gemini 3 Pro</a> (Google) and <a href="https://openai.com/index/introducing-gpt-5/" target="_blank" rel="noopener noreferrer">GPT-5</a> (OpenAI)</>,
        ]}
      />
      <Entry
        title="Otter & MIMIC-IT: Multi-Modal In-Context Instruction Tuning"
        date="Jun 2023 – Dec 2023"
        detail="IEEE TPAMI, Co-first author"
        items={[
          <>Early experiment on vision-language-agent (VLA) model with <strong>3.3K GitHub stars</strong></>,
